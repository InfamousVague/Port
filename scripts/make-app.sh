...
# build still completes, just signed-only. (Was dmg-only + would
# hard-abort the build under `set -e` on any notarization hiccup;
# this staples the app too and degrades gracefully.)
